...
//
  ...
  // far(var keys in controls2){
  //   fill(controls2[keys][3]);
  //   rect(controls2[keys][0], controls2[keys][1], controls2[keys][2], controls2[keys][2]);
  //   text(keys, controls2[keys][0], controls2[keys][1] - 10);
  //
  //
  // }
